 !function(e) {
    var n = {
        title: "江南布衣+",
        desc: "JNBY DESIGN LIMITED（股票代码:03306.HK) 二零一六/一七财年全年业绩发布",
        link: window.location.origin + "/jnbymeeting/default.html",
        imgUrl: window.location.origin + "/jnbymeeting/img/share-bg.jpg"
    }
      , i = {
        userid: "",
        debug: !1,
